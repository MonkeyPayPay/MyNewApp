...
function AIAdvisorView({ can, onUpgrade }) {
  ...
  const isLocked = can && !can('ai_advisor')
  ...
  if (isLocked) {
    return (
      <div className="max-w-3xl mx-auto animate-fade-in flex flex-col items-center justify-center py-24 text-center gap-5">
        ...
        <button
          onClick={() => onUpgrade?.('ai_advisor')}
          className="flex items-center gap-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-bold px-6 py-3 rounded-xl hover:opacity-90 transition-opacity"
        >
    ...
    <div className="max-w-3xl mx-auto animate-fade-in">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div className="flex items-center gap-3 flex-shrink-0">
          ...
          <button
            onClick={refresh}
            disabled={loading}
            className="text-indigo-400 hover:text-indigo-300 text-sm font-medium transition-colors disabled:opacity-40 flex items-center gap-1"
          >
      ...
      {!loading && !error && !insights && (
        <div className="glass rounded-2xl p-10 text-center border border-white/5">
          ...
          <p className="text-slate-500 text-sm mb-5">Start logging care activities to unlock AI-generated insights for your circle.</p>
